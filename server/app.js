                    ...
                    res.send(
                      `<!DOCTYPE html>
                        ...
                        <body>
                          ...
                          <script src="/static/js/2.ca047cf5.chunk.js">
                          </script><script src="/static/js/main.7e137946.chunk.js"></script>
                        </body>
                      </html>`
                    )
                  })
...
app.configure(function(){
  app.use(express.static(__dirname+'/build')); // Catch static files
  app.use(app.routes);
});
